...
GEM_NAME = 'optimus-ep' # what ppl will type to install your gem
RUBYFORGE_PROJECT = 'optimus-ep' # The unix name for your project
HOMEPATH = "http://code.google.com/p/#{RUBYFORGE_PROJECT}"
